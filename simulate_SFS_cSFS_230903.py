...
# example usage 
# python /home/trc468/mars/simulate_SFS_cSFS_230903.py -num_MH 12 -T_super_archaic 1e+06 -T_modern_archaic 8e+05 -T_den_nea 4e+05 -T_pulse_ghost_to_MH 1e+05 -T_pulse_ghost_to_NEA 3e+05 -T_pulse_NEA_to_DEN 8e+04 -p_pulse_ghost_to_MH 0.3 -p_pulse_ghost_to_NEA 0.01 -p_pulse_NEA_to_DEN 0.03 -mu 1.25e-08 -N_super_ancestral 10000 -N_ancestral 10000 -N_ghost 10000 -N_modern 20000 -N_archaic 10000 -N_Neanderthal 1000 -N_Denisovan 1000 -out_SFS /tmp/deleteme -replicates 1e+04 
    # the above took 75 seconds for 1e+04 replicates and num_MH=12 
# python /home/trc468/mars/simulate_SFS_cSFS_230903.py -num_MH 50 -T_super_archaic 1e+06 -T_modern_archaic 8e+05 -T_den_nea 4e+05 -T_pulse_ghost_to_MH 1e+05 -T_pulse_ghost_to_NEA 3e+05 -T_pulse_NEA_to_DEN 8e+04 -p_pulse_ghost_to_MH 0.3 -p_pulse_ghost_to_NEA 0.01 -p_pulse_NEA_to_DEN 0.03 -mu 1.25e-08 -N_super_ancestral 10000 -N_ancestral 10000 -N_ghost 10000 -N_modern 20000 -N_archaic 10000 -N_Neanderthal 1000 -N_Denisovan 1000 -out_SFS /tmp/deleteme -replicates 1e+04 
    # the above took 100 seconds for 2e+04 replicates and num_MH=50
...
parser.add_argument('-num_MH','--num_MH',help='Number of modern human chromosomes',required=True,type=int,default=12)
...
parser.add_argument('-min_time','--min_time',help='min time in discritisation (in generations)',required=False,type=int,default=0)
parser.add_argument('-max_time','--max_time',help='max time in discritisation (in generations)',required=False,type=float,default=6e+05)
parser.add_argument('-T_super_archaic','--T_super_archaic',help='split time in years of root of (ancestral_humans,ghost)',required=True,type=float)
parser.add_argument('-T_modern_archaic','--T_modern_archaic',help='split time in years of main human lineage and lineage leading to (DEN,NEA)',required=True,type=float)
parser.add_argument('-T_den_nea','--T_den_nea',help='split time in years between NEA and DEN',required=True,type=float)
parser.add_argument('-T_pulse_ghost_to_MH','--T_pulse_ghost_to_MH',help='time in years at which super archaic ghost introgresses into modern humans',required=True,type=float)
parser.add_argument('-T_pulse_ghost_to_NEA','--T_pulse_ghost_to_NEA',help='time in years at which super archaic ghost introgresses into Neanderthals',required=True,type=float)
parser.add_argument('-T_pulse_NEA_to_DEN','--T_pulse_NEA_to_DEN',help='time in years at which which Neanderthals introgress into Denisovans',required=True,type=float)
parser.add_argument('-p_pulse_ghost_to_MH','--p_pulse_ghost_to_MH',help='pulse fraction for archaic ghost introgression into modern humans',required=True,type=float)
parser.add_argument('-p_pulse_ghost_to_NEA','--p_pulse_ghost_to_NEA',help='pulse fraction for archaic ghost introgression into Neanderthals',required=True,type=float)
parser.add_argument('-p_pulse_NEA_to_DEN','--p_pulse_NEA_to_DEN',help='pulse fraction for introgression into Denisovans',required=True,type=float)
parser.add_argument('-N_super_ancestral','--N_super_ancestral',help='Population size of super ancestral branch',required=True,type=int)
parser.add_argument('-N_ancestral','--N_ancestral',help='Population size of ancestral branch',required=True,type=int)
parser.add_argument('-N_ghost','--N_ghost',help='Population size of ghost lineage',required=True,type=int)
parser.add_argument('-N_modern','--N_modern',help='Population size of modern human lineage',required=True,type=int)
parser.add_argument('-N_archaic','--N_archaic',help='Population size of archaic branch',required=True,type=int)
parser.add_argument('-N_Neanderthal','--N_Neanderthal',help='Population size of Neanderthal lineage',required=True,type=int)
parser.add_argument('-N_Denisovan','--N_Denisovan',help='Population size of Denisovan lineage',required=True,type=int)
